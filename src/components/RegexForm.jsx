...
class RegexForm extends Component {
  ...
  render() {
    return (
      <form className="RegexForm" onSubmit={this._handleSubmit}>
        ...
        <div className="Regex-input-container flag-container">
          ...
          <input type="text" id="flag-input" spellCheck="false" placeholder="/flags" value={this.state.flags} onChange={this._handleFlags} pattern="[gimsxeU]*"/>
        </div>
